...
def main():
  ...
  # We want to store our new document inside a shared drive
  # named 'GDriveTools_Test'.
  ...
  # Since we want to store our document inside a shared drive, we need
  # to append its name as the first entry.
  destinationPath = f'{sharedDriveName}/simple/test'
