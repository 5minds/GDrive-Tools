"""
This example creates and moves a document inside a shared drive.
"""
...
def main():
  ...
  # contains the file that we want to move inside this shared drive.
  ...
  destinationPath = f'{sharedDriveName}/moved/newDocumentTitle'
