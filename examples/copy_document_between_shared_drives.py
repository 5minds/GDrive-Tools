"""
This example creates a document in a shared drive and copies it to another.
"""
...
def main():
  ...
  # the 'simple/test' path inside the shared drive with the given name.
  destinationPath = f'{sourceSharedDriveName}/simple/test'
  docname = 'sample'
  ...
  # Since we want to copy our document to another shared drive, we also
  ...
  destinationPath = f'{destinationSharedDriveName}/copies/newDocumentTitle'
